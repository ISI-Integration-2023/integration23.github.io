...
//ob_start();
session_start();
if(!isset($_SESSION['id'])){header('Location: https://www.isical.ac.in/~integration/generate_admit.php');}
?>
...
<body>
        ...
        <?php 
        include_once('./DAL/mathdata_dal.php');
        include_once('./Model/mathdata_model2.php');
        include_once('./Model/mathdata_model.php');
//echo 1111;
        if(isset($_SESSION['pay']) && isset($_SESSION['id']) && $_SESSION['pay']=='1') {
                $id = $_SESSION['id'];//echo $id;echo $_SESSION['pay'];
                $dalObj = new mathdata_dal();        	//echo 12345;
                $query = 'studentid = '.$id;
                $userdata = $dalObj->getDatasForAdmit($query);
                $userdata = reset($userdata);        
        } else {
	header('Location: https://www.isical.ac.in/~integration/generate_admit.php');
	//$userdata = new userdata_model;
        ...
        <!-- Login Form -->
                ...
                <div class="form-group">
                        <div class="form-label-group">
                                <label for="date_of_birth">Date Of Birth (Cannot be modified)</label>
                                <input disabled type="date" name = "date_of_birth" id="date_of_birth" class="form-control" value = "<?php echo($userdata->date_of_birth);?>" placeholder="Your Date of Birth" autofocus="autofocus">
                ...
                <div class="form-group">
                        <div class="form-label-group">
                                <label for="phone1">Phone / Contact (Cannot be modified)</label>
                                <input disabled type="text" name = "phone1" id="phone1" class="form-control" value = "<?php echo($userdata->phone1);?>" placeholder="Your contact number" autofocus="autofocus"> 
                        </div>
                </div>
                <div class="form-group">
                        <div class="form-label-group">
                ...
                <div class="form-group">
                        <div class="form-label-group">
                                <label for="email">Email (Cannot be modified)</label>
                                <input disabled type="email" name = "email" id="email" class="form-control" value = "<?php echo($userdata->email);?>" placeholder="Your Email address" autofocus="autofocus">
...
$.alert({
	title: 'Attention!',
	content: 'Please check all the details and do all necessary modifications.\nHowever, you cannot change your email, date of birth, class, phone number and zone. To modify these fields, please contact the organizers.',
	buttons:{
		OK:function(){
