<?php 
//header('Location:https://www.isical.ac.in/~integration/under_main.html');
ob_start();
session_start(); 
?>
...
<body>
        ...
        <div class="container" style="max-width:500px">
                <div class="card card-login mx-auto my-5 rounded">
                        ...
                        <p style="font-family: 'Abril Fatface';">(For online registrations only)</p>
                        </div>
        ...
        $(document).ready(function(){
				...
				console.log(formData);//////////////
						...
						if(parseInt(retval)==1){
							...
							window.location.replace(RootPathHost+'/edit.php');
						}else{
							$.alert({
                                                        title: 'Error',
                                                        content: 'Looks like you have not paid the registration fee for the exam. If you have made the payment recently, please wait one day after making the payment and try again. If the problem still persists, contact the organizers.',
                                                        buttons : {
                                                        Cancel: function () {
							...
							"Pay Now": function(){
								window.location.replace(RootPathHost+'/math_payment.php');
                                                ...
                                                $.alert({
                                                        title: 'Error',
                                                        content: 'Looks like you have not registered or paid for the exam. Please click ok to register for the exam first. If you have already made the payment, please wait one day after making the payment and try again. If the problem still persists, contact the organizers.',
                                                        buttons : {
                                                        OK: function () {
